...
Mineradio Navidrome Player can connect to a Navidrome server the user operates or is authorized to access through its OpenSubsonic / Subsonic-compatible interface. Navidrome is an independent project; this repository does not provide its service, accounts, hosting, or music content.

The source tree also contains adapters for other music services. Use of any third-party service must comply with its applicable terms, copyright rules, and subscription entitlements.
