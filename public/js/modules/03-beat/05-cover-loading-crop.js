...
function loadCoverFromUrl(directUrl, opts) {
  ...
  var inlineCover = typeof isInlineCoverSrc === 'function' && isInlineCoverSrc(directUrl);
  if (!directUrl || typeof directUrl !== 'string' || (!inlineCover && !/^https?:\/\//i.test(directUrl) && !/^mineradio-local:\/\/cover\//i.test(directUrl))) {
