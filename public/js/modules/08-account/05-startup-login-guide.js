...
function maybeRunStartupLoginGuide(source) {
  ...
  if (typeof hasAnyConnectedMusicSource === 'function' && hasAnyConnectedMusicSource()) return;
  ...
  setTimeout(function () {
    if ((typeof hasAnyConnectedMusicSource === 'function' && hasAnyConnectedMusicSource()) || loginStatus.loggedIn || playing || immersiveMode || document.body.classList.contains('splash-active')) return;
