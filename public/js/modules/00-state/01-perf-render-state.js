...
var playlistPanelDetailState = {
  key: '', loading: false, loadingMore: false, playlist: null, tracks: [], token: 0,
  total: 0, nextOffset: 0, hasMore: false, scrollTop: 0, controller: null, warmTimer: 0,
  renderLimit: PLAYLIST_DETAIL_INITIAL_RENDER, error: '', message: ''
};
var playlistPanelVirtualCache = {
  revision: -1, detailKey: '', detailSig: '', entries: [], offsets: [0], totalHeight: 0, raf: 0
};
