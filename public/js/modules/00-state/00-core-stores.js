...
var userPlaylists = [], neteasePlaylists = [], qqPlaylists = [], kugouPlaylists = [], qishuiPlaylists = [], spotifyPlaylists = [], navidromePlaylists = [], myPodcastCollections = [], myPodcastItems = {}, playlistCoverCache = {};
...
var PLAYBACK_QUALITY_DEFAULTS = { netease: 'hires', qq: 'lossless', kugou: 'lossless', qishui: 'standard', spotify: 'standard', navidrome: 'original' };
var PLAYBACK_QUALITY_OPTIONS = {
  ...
  navidrome: [
    { key: 'original', title: '原始音质', sub: '服务器原文件 / 默认' },
    { key: '320', title: '最高 320 kbps', sub: '由 Navidrome 转码配置决定' },
    { key: '192', title: '最高 192 kbps', sub: '由 Navidrome 转码配置决定' },
    { key: '128', title: '最高 128 kbps', sub: '由 Navidrome 转码配置决定' }
  ]
};
